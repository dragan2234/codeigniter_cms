...
function btn_delete($uri){
	return anchor($uri, '<i class="glyphicon glyphicon-remove
"></i>',array(
    ...
    if (count($array)) {
        ...
        foreach ($array as $item) {
            ...
            if (isset($item['children']) && count($item['children'])) {
                $str .= $active ? '<li class="dropdown">' : '<li class="dropdown active">' ;
                $str .= '<a class="dropdown-toggle disabled" data-toggle="dropdown" href="' . site_url($item['slug']) . '">' . e($item['title']) ;
